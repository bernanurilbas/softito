...
const Demo1JSXBasic =()=>{
    ...
    return (
        <div className="p-4">
            <h3 className="text-xl font-bold">Demo1: Temel JSX Kulluanımı</h3>

            <div className="mt-4">
                <p className="border-b"><strong>Derse Adı:</strong>{dersAdi}</p>
                <p className="border-b"><strong>Öğrenci Sayısı:</strong>{ogrenciSayisi}</p>
                <p className="border-b"><strong>Derse Yılı:</strong>{dersYili}</p>
                <p className="border-b"><strong>İşlem:</strong>{2+2}</p>
                <p className="border-b"><strong>Metin Dönüştürme:</strong>{dersAdi.toUpperCase()}</p>
                <p className="border-b"><strong>Derse Durumu:</strong>{aktifMi ? "Aktif":"Pasif"}</p>
            </div>
